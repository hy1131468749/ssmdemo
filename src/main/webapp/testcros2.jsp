...
<script
	src="/ssmdemo/public/bootstrap-table/src/locale/bootstrap-table-zh-CN.js"></script>
<script src="/ssmdemo/public/axios.min.js"></script>
...
<script>
	...
	function testcors(){
	  ...
	  $.ajax({
          type:'post',
          url:'http://192.168.11.23:8080/EMGD/test/testSubject',
          data:{"data":"1"},
          cache:false,
          dataType:'json',
